#!/usr/bin/env python3
"""Generate MarNameRefGen_Enemy.cpp from extracted asm entries."""
import io
import re
import sys
...
asm = Path("build/GMSJ01/asm/System/MarNameRefGen_Enemy.s").read_text()
...
fn_body = re.search(
    r"\.fn getNameRef_Enemy__14TMarNameRefGenCFPCc.*?\n(.*?)\n\.endfn", asm, re.S,
).group(1)
instr = []
...
# Parse weak destructors for inheritance discovery
weak_dt_to_parent = {}
for m in re.finditer(
    ...
    if (m or m2) and i + 1 < len(instr) and "bl strcmp" in instr[i + 1]:
        ...
        for j in range(i + 2, min(i + 25, len(instr))):
            ...
            if cm:
                ...
                vtable_class = None
                for kk in range(j + 1, min(j + 25, len(instr))):
...
class_to_header = {
    "TTypicalEnemy": "Enemy/TypicalEnemy.hpp",
    "TTypicalManager": "Enemy/TypicalEnemy.hpp",
    "TRiccoHook": "Enemy/RiccoHook.hpp",
    "TRiccoHookManager": "Enemy/RiccoHook.hpp",
    "TEnemyManager": "Enemy/EnemyManager.hpp",
    "TAnimalBase": "Animal/AnimalBase.hpp",
    "TAnimalManagerBase": "Animal/AnimalManager.hpp",
    "TEggGenerator": "Enemy/EggGen.hpp",
    "TEggGenManager": "Enemy/EggGen.hpp",
    "TEffectColumWaterManager": "Enemy/EffectObj.hpp",
    "TEffectBombColumWaterManager": "Enemy/EffectObj.hpp",
    "TEffectColumSandManager": "Enemy/EffectObj.hpp",
    "TEffectExplosionManager": "Enemy/EffectObj.hpp",
    "TSmallEnemyManager": "Enemy/SmallEnemy.hpp",
    "TSimpleEffect": "Enemy/EffectObj.hpp",
    "TSpineEnemy": "Enemy/Enemy.hpp",
    "TPoiHanaManager": "Enemy/PoiHana.hpp",
    "TPoiHana": "Enemy/PoiHana.hpp",
    "TSleepPoiHana": "Enemy/PoiHana.hpp",
    "THamuKuriManager": "Enemy/HamuKuri.hpp",
    "THamuKuri": "Enemy/HamuKuri.hpp",
    "THaneHamuKuriManager": "Enemy/HamuKuri.hpp",
    "THaneHamuKuri": "Enemy/HamuKuri.hpp",
    "THaneHamuKuri2": "Enemy/HamuKuri.hpp",
    "TDoroHaneKuriManager": "Enemy/HamuKuri.hpp",
    "TDoroHaneKuri": "Enemy/HamuKuri.hpp",
    "TDangoHamuKuriManager": "Enemy/HamuKuri.hpp",
    "TBossDangoHamuKuriManager": "Enemy/HamuKuri.hpp",
    "TBossDangoHamuKuri": "Enemy/HamuKuri.hpp",
    "TFireHamuKuriManager": "Enemy/HamuKuri.hpp",
    "TFireHamuKuri": "Enemy/HamuKuri.hpp",
    "TDoroHamuKuriManager": "Enemy/HamuKuri.hpp",
    "TDoroHamuKuri": "Enemy/HamuKuri.hpp",
    "TNameKuriManager": "Enemy/NameKuri.hpp",
    "TNameKuri": "Enemy/NameKuri.hpp",
    "TBoxTelesa": "Enemy/Telesa.hpp",
    "TLoopTelesa": "Enemy/Telesa.hpp",
    "TMarioModokiTelesa": "Enemy/Telesa.hpp",
    "TSeeTelesa": "Enemy/Telesa.hpp",
    "TTelesa": "Enemy/Telesa.hpp",
    "TTelesaManager": "Enemy/Telesa.hpp",
    "TGesso": "Enemy/Gesso.hpp",
    "TGessoManager": "Enemy/Gesso.hpp",
    "TMameGesso": "Enemy/MameGesso.hpp",
    "TMameGessoManager": "Enemy/MameGesso.hpp",
    "TWalkerEnemy": "Enemy/WalkerEnemy.hpp",
    "TLauncher": "Enemy/Launcher.hpp",
    "TLauncherManager": "Enemy/Launcher.hpp",
    "TCommonLauncher": "Enemy/Launcher.hpp",
    "TCommonLauncherManager": "Enemy/Launcher.hpp",
    "TKumokun": "Enemy/Kumokun.hpp",
    "TKumokunManager": "Enemy/Kumokun.hpp",
    "TTamaNoko": "Enemy/TamaNoko.hpp",
    "TTamaNokoManager": "Enemy/TamaNoko.hpp",
    "TAmenbo": "Enemy/Amenbo.hpp",
    "TAmenboManager": "Enemy/Amenbo.hpp",
    "TRocket": "Enemy/Rocket.hpp",
    "TBeamManager": "Enemy/Beam.hpp",
    "TFireWanwan": "Enemy/FireWanwan.hpp",
    "TFireWanwanManager": "Enemy/FireWanwan.hpp",
    "JDrama::TActor": "JSystem/JDrama/JDRActor.hpp",
    "TDiffusionNameKuriManager": "Enemy/NameKuri.hpp",
    "TDiffusionNameKuri": "Enemy/NameKuri.hpp",
    "TSurfGesso": "Enemy/Gesso.hpp",
    "TLandGesso": "Enemy/Gesso.hpp",
    "TPoiHanaRed": "Enemy/PoiHana.hpp",
    "TKageMarioModokiManager": "Enemy/Telesa.hpp",
    "TKageMarioModoki": "Enemy/Telesa.hpp",
    "THamuKuriLauncher": "Enemy/HamuKuri.hpp",
    "TNameKuriLauncher": "Enemy/NameKuri.hpp",
    "TMewManager": "Animal/AnimalManager.hpp",
...
header_classes_with_name_ctor = {
    "TAmenbo", "TAmenboManager", "TBeamManager",
    "TBossDangoHamuKuri", "TBossDangoHamuKuriManager",
    "TCommonLauncher", "TCommonLauncherManager",
    "TDangoHamuKuri", "TDangoHamuKuriManager",
    "TDiffusionNameKuri", "TDiffusionNameKuriManager",
    "TDoroHamuKuri", "TDoroHamuKuriManager",
    "TDoroHaneKuri", "TDoroHaneKuriManager",
    "TEffectBiancoFunsui", "TEffectBombColumWater", "TEffectBombColumWaterManager",
    "TEffectColumSand", "TEffectColumSandManager", "TEffectColumWater",
    "TEffectColumWaterManager", "TEffectExplosion", "TEffectExplosionManager",
    "TEffectModel", "TEffectModelManager",
    "TEggGenManager", "TEggGenerator", "TEnemyManager",
    "TFireHamuKuri", "TFireHamuKuriManager",
    "TFireWanwan", "TFireWanwanManager",
    "TGesso", "TGessoManager",
    "THamuKuri", "THamuKuriLauncher", "THamuKuriManager",
    "THaneHamuKuri", "THaneHamuKuri2", "THaneHamuKuriManager",
    "THinokuri2", "THinokuri2Manager",
    "TKageMarioModoki", "TKageMarioModokiManager",
    "TKumokun", "TKumokunManager",
    "TLandGesso", "TLauncher", "TLauncherManager",
    "TLoopTelesa", "TMameGesso", "TMameGessoManager",
    "TMarioModokiTelesa", "TNameKuri", "TNameKuriLauncher", "TNameKuriManager",
    "TPoiHana", "TPoiHanaManager", "TPoiHanaRed", "TRiccoHook", "TRiccoHookManager",
    "TRocket", "TSeeTelesa", "TSleepPoiHana",
    "TSmallEnemyManager", "TSpineEnemy", "TSurfGesso",
    # TSimpleEffect is abstract (emitEffect = 0); skip

    "TTamaNoko", "TTamaNokoManager", "TTelesa", "TTelesaManager",
    "TTypicalEnemy", "TTypicalManager", "TWalkerEnemy",
    "TBoxTelesa",
}
...
if needed_stubs:
    ...
    # Use weak destructor chain to find parents of remaining stubs
    for _ in range(5):
        changed = False
    ...
    def ctor_decl_for(cls, args, named=False):
        if args in ("Fv", "v"):
            return f"{cls}();" if not named else f"{cls}() {{}}"
        if args in ("FiPCc", "iPCc", "FUlPCc", "UlPCc"):
            t = "int" if args in ("FiPCc", "iPCc") else "u32"
            return f"{cls}({t}, const char*);"
    ...
    for cls in sorted(needed_stubs):
        ...
        # If base is in headers, use it (inline destructor emits weak symbol).
...
print("JDrama::TNameRef* TMarNameRefGen::getNameRef_Enemy(const char* name) const", file=out)
print("{", file=out)
for e in entries:
    cmp_s = e["cmp"]
